...
const CtaSection = ({ showButton = false }) => (
  ...
  <section className="tp-cta-2__area">
    <div 
      ...
      style={{ backgroundImage: "url(/assets/cta-bg-1.png)" }}
    >
      <div className="tp-cta-2__shape-1 d-none d-xl-block">
        <img src="/assets/cta-shape-1.png" alt="" loading="lazy" decoding="async" />
      </div>
      <div className="tp-cta-2__shape-2 d-none d-xl-block">
        <img src="/assets/cta-shape-2.png" alt="" loading="lazy" decoding="async" />
      </div>
