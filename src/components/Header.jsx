...
const Header = () => {
  ...
  return (
    <header className={`site-header${isScrolled ? ' header-sticky' : ''}`}>
        ...
        <div className="header-content">
          <div className="header-top-bar">
            <div className="header-top-left">
              <span className="header-connect-text">Connect with us</span>
            ...
            <div className="header-top-right">
              <div className="header-top-item">
                ...
                <a href="https://share.google/8p6fPKh4koI7upbVe" target="_blank" rel="noreferrer">Topley House, 52 Washlane Bury Greater Manchester</a>
              </div>
              <div className="header-top-item">
            ...
            <div className={`nav-menu${menuOpen ? ' active' : ''}`}>
             ...
             <div className="header-right">
              <div className="header-actions">
                <button type="button" className="header-action-btn" aria-label="Search">
                  <i className="flaticon-loupe"></i>
                </button>
                <button type="button" className="header-action-btn" aria-label="Account">
                  <i className="flaticon-user"></i>
                </button>
              </div>

              <a
                href="https://linktr.ee/experiencepneuma?utm_source=linktree_profile_share"
                target="_blank"
                rel="noreferrer"
              ...
              <div className="header-call">
                ...
                <div className="header-call-text">
